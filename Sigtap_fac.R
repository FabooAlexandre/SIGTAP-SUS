...
add_formatted_sheet(wb, "tb_grupo", tb_grupo.ds)
add_formatted_sheet(wb, "tb_sub_grupo", tb_sub_grupo.ds)
add_formatted_sheet(wb, "tb_forma_organizacao", tb_forma_organizacao.ds)
add_formatted_sheet(wb, "tb_procedimento", tb_procedimento.ds)
add_formatted_sheet(wb, "tb_financiamento", tb_financiamento.ds)
add_formatted_sheet(wb, "rl_procedimento_compativel", rl_procedimento_compativel.ds)
add_formatted_sheet(wb, "rl_excecao_compatibilidade", rl_excecao_compatibilidade.ds)
add_formatted_sheet(wb, "tb_cid", tb_cid.ds)
add_formatted_sheet(wb, "rl_procedimento_cid", rl_procedimento_cid.ds)
add_formatted_sheet(wb, "tb_detalhe", tb_detalhe.ds)
add_formatted_sheet(wb, "rl_procedimento_detalhe", rl_procedimento_detalhe.ds)
add_formatted_sheet(wb, "tb_habilitacao", tb_habilitacao.ds)
add_formatted_sheet(wb, "tb_grupo_habilitacao", tb_grupo_habilitacao.ds)
add_formatted_sheet(wb, "rl_procedimento_habilitacao", rl_procedimento_habilitacao.ds)
add_formatted_sheet(wb, "rl_procedimento_incremento", rl_procedimento_incremento.ds)
add_formatted_sheet(wb, "tb_tipo_leito", tb_tipo_leito.ds)
add_formatted_sheet(wb, "rl_procedimento_leito", rl_procedimento_leito.ds)
add_formatted_sheet(wb, "tb_modalidade", tb_modalidade.ds)
add_formatted_sheet(wb, "rl_procedimento_modalidade", rl_procedimento_modalidade.ds)
add_formatted_sheet(wb, "tb_registro", tb_registro.ds)
add_formatted_sheet(wb, "rl_procedimento_registro", rl_procedimento_registro.ds)
add_formatted_sheet(wb, "tb_servico", tb_servico.ds)
add_formatted_sheet(wb, "tb_servico_classificacao", tb_servico_classificacao.ds)
add_formatted_sheet(wb, "rl_procedimento_servico", rl_procedimento_servico.ds)
add_formatted_sheet(wb, "tb_ocupacao", tb_ocupacao.ds)
add_formatted_sheet(wb, "rl_procedimento_ocupacao", rl_procedimento_ocupacao.ds)
add_formatted_sheet(wb, "tb_rubrica", tb_rubrica.ds)
add_formatted_sheet(wb, "tb_sia_sih", tb_sia_sih.ds)
add_formatted_sheet(wb, "rl_procedimento_sia_sih", rl_procedimento_sia_sih.ds)
add_formatted_sheet(wb, "rl_procedimento_origem", rl_procedimento_origem.ds)
add_formatted_sheet(wb, "tb_descricao", tb_descricao.ds)
add_formatted_sheet(wb, "tb_descricao_detalhe", tb_descricao_detalhe.ds)
